...
export interface GatewayForwarderContract
  extends Truffle.Contract<GatewayForwarderInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<GatewayForwarderInstance>;
}
...
export interface GatewayForwarderInstance extends Truffle.ContractInstance {
  ...
  trustedRelayHub(txDetails?: Truffle.TransactionDetails): Promise<string>;
  ...
  setTrustedRelayHub: {
    (_trustedRelayHub: string, txDetails?: Truffle.TransactionDetails): Promise<
