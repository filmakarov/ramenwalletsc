...
export interface ArbRelayHubContract
  extends Truffle.Contract<ArbRelayHubInstance> {
  "new"(
    _arbsys: string,
...
export interface ArbRelayHubInstance extends Truffle.ContractInstance {
  /**
  ...
  arbsys(txDetails?: Truffle.TransactionDetails): Promise<string>;
   ...
   */
  getL1CreationBlock(txDetails?: Truffle.TransactionDetails): Promise<BN>;
